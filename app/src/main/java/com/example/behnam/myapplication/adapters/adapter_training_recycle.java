 ...
 */
public class adapter_training_recycle extends RecyclerView.Adapter<adapter_training_recycle.MyViewHolder> {
...
Context context;
    ...
    public adapter_training_recycle(ArrayList<String> web) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.exercise_item_drug, parent, false);
