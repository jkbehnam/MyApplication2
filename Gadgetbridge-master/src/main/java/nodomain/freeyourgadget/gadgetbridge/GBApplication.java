...
import nodomain.freeyourgadget.gadgetbridge.database_pack.OfflinePlayerApplication;
...
public class GBApplication extends Application {
    ...
    static GBApplication application;
...
//Boolean b=prefs.getBoolean("auto_fetch_enabled", true);
        if (true) {
            registerReceiver(new GBAutoFetchReceiver(), new IntentFilter("android.intent.action.USER_PRESENT"));
            registerReceiver(new GBAutoFetchReceiver(), new IntentFilter("android.intent.action.TIME_TICK"));
        }
    }
