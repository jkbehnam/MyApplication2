...
import nodomain.freeyourgadget.gadgetbridge.database_pack.save_to_table;
    ...
    private GregorianCalendar saveSamples() {
        if (samples.size() > 0) {
            ...
            try (DBHandler handler = GBApplication.acquireDB()) {
                ...
                Log.d("timmmme",String.valueOf (timestamp.getTimeInMillis() / 1000));
                //behnam
                ...
                //behnam
                save_to_table s = new save_to_table();
                s.save_today_data(samples, getContext());
                //behnam
